...
class ImgCommentRecyclerAdapter extends RecyclerView.Adapter<ImgCommentRecyclerAdapter.ViewHolder> {
    ...
    public ImgCommentRecyclerAdapter(Context context, List<CommentData> mCommentData) {
        mContext = context;
...
//        inflating the layout the was added to the recycler list then passing its value to the constructor of the view Holder class
        itemView = mLayoutInflater.inflate(R.layout.post_img_comment_list, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            mComUserImg = itemView.findViewById(R.id.comment_image2);
            mComUserName = itemView.findViewById(R.id.comment_name2);
            mComUserPost = itemView.findViewById(R.id.comment_post2);
            mComUsersDate = itemView.findViewById(R.id.comment_date2);
